...
import heroImage1 from '../assets/OIP (1).jpg';
import heroImage2 from '../assets/OIP (2).jpg';
...
const Home = () => {
  ...
  return (
    <div className="flex flex-col w-full bg-gray-900 text-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/2">
              <img
                src="https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
                alt="Mobile Banking"
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row-reverse items-center gap-10">
            <div className="w-full md:w-1/2">
              ...
              <img
                src="https://images.unsplash.com/photo-1579389083078-4e7018379f7e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
                alt="Bill Reminders"
                className="rounded-lg shadow-lg"
              />
            </div>
      ...
      <button className="bg-gradient-to-r from-primary to-accent text-white px-6 py-2 rounded-xl shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-300 font-semibold">
        Modern Button
      </button>

      <input className="bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-primary focus:outline-none transition-all duration-300" />
    </div>
  );
};
